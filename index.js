...
app.get('/retrievediff/:reviewName/:fileName', verified, (req, res) => {
  var diffPath = path.join(filePaths, req.params.reviewName, req.params.fileName);
  var strInput = fs.readFileSync(diffPath, "utf8");
...
app.get('/comments/:reviewName/:fileName', verified, (req, res) => {
  Comment.find({'Review':req.params.reviewName, 'FileName':req.params.fileName}, (err, comments) => {
    if (err) {
      res.send(err);
    }
...
app.post('/createcomment/:reviewName/:fileName/:comment', verified, (req, res) => {
  var comment = new Comment();
  comment.Review = req.params.reviewName;
  comment.FileName = req.params.fileName;
  comment.Text = req.params.comment;
